...
#ifndef IMOJESDK_SWIFT_H
#define IMOJESDK_SWIFT_H
...
SWIFT_CLASS("_TtC8iMojeSDK18INGApplePayHandler") SWIFT_AVAILABILITY(ios,introduced=11.0)
@interface INGApplePayHandler : NSObject
...
@interface INGApplePayHandler (SWIFT_EXTENSION(iMojeSDK)) <PKPaymentAuthorizationViewControllerDelegate>
...
/// iMojeSDK
SWIFT_CLASS("_TtC8iMojeSDK5iMoje")
@interface iMoje : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) iMoje * _Nonnull sharedInstance;)
+ (iMoje * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// Rise when user cancel apple payment
  iMojeSDKErrorApplePayUserCancelled = 5,
/// Rise when ApplePay is not supported
  iMojeSDKErrorApplePayNotSupported = 6,
/// Unknown error
  iMojeSDKErrorUnknown = 7,
};
